		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item"><a class="nav-link" href="/jobs/home">Home</a>
					</li>
					<li class="nav-item"><a class="nav-link" href="/jobs/viewalljobs">All
							Jobs</a></li>
					<li class="nav-item"><a class="nav-link"
						href="https://sauraevshing-portfolio.netlify.app/">Contact</a></li>
				</ul>
			</div>
		</div>
	</nav>
			...
			<div class="col-md-6 mb-5">
				<div class="card bg-warning">
					<div class="card-body text-center">
						...
						<form action="/jobs/viewalljobs" method="get">
			...
			<div class="col-md-6 mb-5">
				<div class="card">
					<div class="card-body text-center">
						...
						<form action="/jobs/addjob" method="get">
